...
| Date | Topics | Notes |
|------|--------|-------|
| [2026-06-10](2026-06-10.md) | Player Control FSM | Converted player control to an explicit FSM with owned state data, centralized transitions, and event-based scene/animation flow. |
