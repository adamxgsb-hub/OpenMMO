...
pub fn msg_name(msg: &onlinerpg_shared::ServerMessage) -> &'static str {
    ...
    match msg {
        ...
        ServerMessage::MiningStrike { .. } => "MiningStrike",
        ServerMessage::MiningEnded { .. } => "MiningEnded",
        ServerMessage::MiningNodeDepleted { .. } => "MiningNodeDepleted",
        ServerMessage::MiningNodeRespawned { .. } => "MiningNodeRespawned",
        ServerMessage::MiningError { .. } => "MiningError",
