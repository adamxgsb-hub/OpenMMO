...
pub fn msg_name(msg: &onlinerpg_shared::ServerMessage) -> &'static str {
    ...
    match msg {
        ...
        ServerMessage::ChopStarted { .. } => "ChopStarted",
        ServerMessage::ChopSwing { .. } => "ChopSwing",
        ServerMessage::WoodcuttingEnded { .. } => "WoodcuttingEnded",
        ServerMessage::TreeFelled { .. } => "TreeFelled",
        ServerMessage::TreeRespawned { .. } => "TreeRespawned",
        ServerMessage::TreeStumps { .. } => "TreeStumps",
        ServerMessage::WoodcuttingError { .. } => "WoodcuttingError",
