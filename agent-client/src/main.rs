...
pub fn msg_name(msg: &onlinerpg_shared::ServerMessage) -> &'static str {
    ...
    match msg {
        ...
        ServerMessage::BoatSpawned { .. } => "BoatSpawned",
        ServerMessage::BoatState { .. } => "BoatState",
        ServerMessage::BoatRemoved { .. } => "BoatRemoved",
        ServerMessage::BoatBoarded { .. } => "BoatBoarded",
        ServerMessage::BoatLeft { .. } => "BoatLeft",
        ServerMessage::BoatError { .. } => "BoatError",
